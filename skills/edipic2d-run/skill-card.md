## Description
Prepare, execute, and validate EDIPIC-2D low-temperature plasma simulations with reproducible input files, dependency provenance, particle/noise checks, and canonical output conversion.
