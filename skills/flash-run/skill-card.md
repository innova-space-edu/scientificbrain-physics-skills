## Description
Launch, monitor, restart, and provenance-track a configured FLASH simulation, preserving parameters, logs, checkpoints, plotfiles, executable identity, and failure diagnostics.
...
## Use case
Use when an agent needs to launch, monitor, restart, and provenance-track a configured FLASH simulation, preserving parameters, logs, checkpoints, plotfiles, executable identity, and failure diagnostics.
