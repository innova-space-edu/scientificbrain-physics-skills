## Description
Build a complete uncertainty-quantification workflow combining measurement, parameter, numerical, stochastic/PIC noise, surrogate, and model-form uncertainty with explicit propagation and attribution.
