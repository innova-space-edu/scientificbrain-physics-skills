## Description
Configure and audit FLASH 4.8 resistive and Braginskii-style extended-MHD options including Hall, Biermann, Nernst, Seebeck, cross-field and anisotropic magnetic resistivity in the unsplit staggered-mesh solver.
...
## Use case
Use when an agent needs to configure and audit FLASH 4.8 resistive and Braginskii-style extended-MHD options including Hall, Biermann, Nernst, Seebeck, cross-field and anisotropic magnetic resistivity in the unsplit staggered-mesh solver.
