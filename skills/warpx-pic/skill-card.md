## Description
Configure and validate WarpX full kinetic PIC for plasma problems requiring electron/ion phase-space physics, with explicit numerical heating, noise, resolution and convergence controls.
