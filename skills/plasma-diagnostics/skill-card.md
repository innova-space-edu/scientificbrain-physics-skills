## Description
Design solver-independent field, particle, shock, energy, collision, phase-space and synthetic diagnostics with explicit definitions, units, cadence, resolution and uncertainty.
