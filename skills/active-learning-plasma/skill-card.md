## Description
Use PhysicsNeMo active-learning concepts to select new FLASH/PIC/hybrid/Geant4 simulations where additional labels most improve a validated plasma surrogate per unit compute cost.
