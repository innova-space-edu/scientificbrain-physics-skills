## Description
Use openPMD as the canonical exchange layer for particle/mesh simulation data from WarpX/PIConGPU and adapters, preserving SI units, species, coordinates, iterations and provenance.
