## Description
Orchestrate end-to-end physics workflows in ScientificBrain: model/solver routing, remote execution, diagnostics, validation, UQ, multi-fidelity datasets, PhysicsNeMo training, active learning, and provenance.
