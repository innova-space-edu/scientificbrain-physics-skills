## Description
Configure and run large-scale PIConGPU kinetic plasma simulations with explicit parameter provenance, GPU/MPI decomposition, diagnostics, checkpoints, openPMD output and convergence criteria.
