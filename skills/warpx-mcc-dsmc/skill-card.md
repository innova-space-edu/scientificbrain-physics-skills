## Description
Configure, validate, and distinguish WarpX Monte Carlo Collisions (MCC) with neutral backgrounds from DSMC particle-particle stochastic collisions and required cross-section data.
